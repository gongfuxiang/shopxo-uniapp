...
6. 新人礼包支持
7. 订单商品快照开关
8. 多语言支持（含 URL 传参指定语言）
9. HLS 播放支持
10. 签到插件支持余额奖励、页面导航
11. 我的积分页、钱包积分兑换
12. 积分日志增加积分类型
13. 超级会员（原会员等级增强版）首页与命名
14. 会员首页、优惠券首页
15. 送礼插件支持退款
16. 商品详情价格组合布局、购买弹窗、满减满折/优惠券信息合并
17. 购买页订单扩展数据展示（图片、URL、数量限制）
18. 限时秒杀、预售倒计时字段规范，购买支持自定义 buy 页
19. 短视频 App 适配（首页、搜索分享、nvue 页面与播放）
20. App 配置、权限、设备信息读取、微信隐私与 common 调用
21. 收银台返回按钮、底部菜单选中、主题配色与购物车符号
22. 资质认证编辑提示、上传与 Loading 组件
23. 公告、文章列表显示
24. 小程序语法兼容性
25. 订单售后在线客服无效
26. 短视频 App 样式与适配问题
