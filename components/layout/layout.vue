...
<block v-if="(propData || null) != null && propData.length > 0">
  <block v-for="(v, index) in propData" :key="index">
    <view v-if="(v.value || null) != null && (v.children || null) != null && v.children.length > 0 && (v.value_arr || null) != null && v.value_arr.length > 0 && v.children.length == v.value_arr.length && (v.status || 0) == 1" class="layout-view">
                  ...
                  <view :class="'module-' + vss.value + '-container'" :style="((vss.config.frontend_config || null) != null && (vss.config.frontend_config.style || null) != null) ? vss.config.frontend_config.style : ''">
                    ...
                    <block v-if="vss.value == 'images'">
                      <view :class="'module-images-content ' + vss.config.frontend_config.media_fixed.media_container_ent" :style="vss.config.frontend_config.media_fixed.media_container_style">
                        <image @tap="layout_url_event" :data-value="vss.config.url || ''" :src="vss.config.images" mode="widthFix" :class="vss.config.frontend_config.media_fixed.media_ent"></image>
                      </view>
                    </block>
                    ...
                    <block v-else-if="vss.value == 'many-images'">
                        ...
                        <view :class="'module-list-content ' + vss.config.frontend_config.list_ent">
                          <view v-for="(item, index2) in vss.config.data_list" :key="index2" class="item">
                            <view class="module-item" :style="vss.config.frontend_config.item_style">
                              <view :class="vss.config.frontend_config.media_fixed.media_container_ent" :style="vss.config.frontend_config.media_fixed.media_container_style" @tap="layout_url_event" :data-value="item.url || ''">
                                <image :src="item.images" mode="widthFix" :class="vss.config.frontend_config.media_fixed.media_ent"></image>
                              </view>
                            </view>
                          </view>
                      ...
                      <block v-else>
                        <!-- 默认轮播 -->
                        <swiper :indicator-dots="vss.config.data_list.length > 0" :indicator-color="indicator_color" :indicator-active-color="indicator_active_color" :autoplay="vss.config.data_list.length > 0" :circular="circular" :style="vss.config.frontend_config.media_fixed.media_container_style">
                          <block v-for="(item, index2) in vss.config.data_list" :key="index2">
                            <swiper-item :class="vss.config.frontend_config.media_fixed.media_container_ent">
                              <image :src="item.images" mode="aspectFill" :class="vss.config.frontend_config.media_fixed.media_ent" @tap="layout_url_event" :data-value="item.url || ''"></image>
                            </swiper-item>
                          </block>
                        </swiper>
                      </block>
                    ...
                    <block v-else-if="vss.value == 'video'">
                      <view :class="'module-video-content ' + vss.config.frontend_config.media_fixed.media_container_ent" :style="vss.config.frontend_config.media_fixed.media_container_style">
                        <video :src="vss.config.video" :autoplay="false" :show-center-play-btn="true" :controls="false" :show-play-btn="false" :enable-progress-gesture="false" :show-fullscreen-btn="false" :poster="(vss.config.content_images || null) != null ? vss.config.content_images : ''" :class="vss.config.frontend_config.media_fixed.media_ent"></video>
                      </view>
                    </block>
                      ...
                      <block v-if="(vss.config.data_list || null) != null && vss.config.data_list.length > 0">
                        ...
                        <block v-else>
                          ...
                          <view :class="'module-goods-content module-list-content ' + vss.config.frontend_config.list_ent">
                            <view v-for="(item, index2) in vss.config.data_list" :key="index2" class="item">
                              <view class="module-item" :style="vss.config.frontend_config.item_style">
                                <view :class="vss.config.frontend_config.media_fixed.media_container_ent" :style="vss.config.frontend_config.media_fixed.media_container_style" @tap="layout_url_event" :data-value="item.goods_url || ''">
                                  <image :src="item.images" mode="widthFix" :class="vss.config.frontend_config.media_fixed.media_ent"></image>
                                  <view class="item-bottom">
                                    <view class="module-title">{{item.title}}</view>
                                    <view class="module-price">{{currency_symbol}}{{item.price}}</view>
                    ...
                    <block v-else-if="vss.value == 'title'">
                      <view class="module-title-content">
                        ...
                        <text v-if="(vss.config.title_vice || null) != null" class="title-vice" :style="vss.config.frontend_config.style_title_vice">{{vss.config.title_vice}}</text>
                        <view v-if="(vss.config.title_more || null) != null" class="more-content">
                          <view :style="vss.config.frontend_config.style_title_more" @tap="layout_url_event" :data-value="vss.config.title_more_url || ''">{{vss.config.title_more}} ></view>
                        </view>
                      </view>
                    </block>
                  </view>
