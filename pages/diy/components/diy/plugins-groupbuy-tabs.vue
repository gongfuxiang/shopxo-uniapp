...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.tabs_index = content.tabs_active_index || 0;
            this.init();
        },
        mounted() {
            this.$nextTick(() => {
        ...
        methods: {
            init() {
                ...
                new_data.content.brand_ids = new_tabs_data.brand_ids;
            ...
            tabs_click_event(index) {
                ...
                new_data.content.category_ids = tab.category_ids;
                new_data.content.brand_ids = tab.brand_ids;
