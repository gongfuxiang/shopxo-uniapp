        ...
        <block v-if="load_status == 1">
            <block v-if="(plugins_realstore_info || null) != null || is_hide_shop_cart == 1">
                ...
                <block v-if="is_hide_shop_cart != 1">
                    <component-nav-back propClass="bg-white" propColor="#333" :propFixed="false" propStyle="background-color:#fff;">
                ...
                <block v-else>
                    ...
                    <component-nav-back propClass="bg-white" propColor="#333" propNameClass="cr-black" :propName="$t('common.cart')" :propFixed="false" :propIsRightSlot="false" propStyle="background-color:#fff;"></component-nav-back>
                    <!-- #endif -->
                </block>
                <!-- 门店数据 -->
            ...
            <block v-else>
                <!-- #ifndef MP-TOUTIAO || H5 -->
                <component-nav-back propClass="bg-white" propColor="#333" propNameClass="cr-black" :propName="$t('common.cart')" :propFixed="false" :propIsRightSlot="false"></component-nav-back>
                <!-- #endif -->
            </block>
        </block>
