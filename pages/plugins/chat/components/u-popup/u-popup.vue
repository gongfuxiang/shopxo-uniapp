<template>
    <view v-if="showPopup" class="uni-popup" :class="popupstyle + (isDesktop ? ' fixforpc-z-index' : '')" :style="popup_root_style">
...
<script>
    ...
    export default {
        ...
        computed: {
            popup_root_style() {
                return {
                    zIndex: Number(this.propZIndex) || 1000,
                };
            },
            isDesktop() {
        ...
        mounted() {
            ...
            // #endif
            // #ifdef APP-NVUE
            // 修复nvue 遮罩层位置问题：全屏 fixed 即可
            this.maskClass.top = 0;
            // #endif
        },
        // #ifndef VUE3
        // TODO vue2
        ...
        methods: {
            ...
            top(type) {
                ...
                this.maskClass = {
                    ...
                    right: 0,
                    zIndex: 1,
                    backgroundColor: this.propMaskBackgroundColor,
                };
                this.transClass = {
                    position: 'fixed',
                    left: 0,
