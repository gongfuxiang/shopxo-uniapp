<template>
    <view v-if="is_show" class="groupbuy-play-flow border-radius-main bg-white padding-main spacing-mb">
        <view class="play-flow-title text-wrapper title-left-border cr-black text-size-md fw-b">{{ $t('groupbuy.play_rules') }}</view>
        ...
        <view v-if="content_notice.length > 0" class="groupbuy-play-rules">
            <view class="play-rules-title text-wrapper title-left-border cr-black text-size-sm fw-b">{{ $t('groupbuy.group_buy_rules') }}</view>
