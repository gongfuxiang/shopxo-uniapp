...
var zh = {
    ...
    "invoice": {
        "order_invoicing": "订单开票",
        "recharge_invoice": "充值开票",
        "apply_invoice": "去开票",
        "select_invoice_type": "选择开票类型",
        "application_type": "申请类型",
        "invoice_type": "发票类型",
        "invoice_amount": "发票金额",
        "invoice_header": "发票抬头",
        "gift_invoice": "送礼开票",
        "presale_invoice": "预售开票",
        "vip_invoice": "超级会员开票",
        "scanpay_invoice": "扫码收款开票"
    },
    "invoice-detail": {
        "electronic_invoice": "电子发票",
        "click_invoice_name_copy_then_go": "可点击发票名称复制后、到浏览器打开地址下载发票。",
    ...
    "invoice-saveinfo": {
        ...
        "invoicing": "开票",
        "invoice_amount_must_greater_than": "发票金额必须大于0",
...
var en = {
    ...
    "invoice": {
        "order_invoicing": "Order invoicing",
        "recharge_invoice": "Recharge invoice",
        "apply_invoice": "Apply invoice",
        "select_invoice_type": "Select invoice type",
        "application_type": "Application type",
        "invoice_type": "Invoice type",
        "invoice_amount": "Invoice amount",
        "invoice_header": "Invoice header",
        "gift_invoice": "Gift invoicing",
        "presale_invoice": "Presale invoicing",
        "vip_invoice": "VIP invoicing",
        "scanpay_invoice": "Scan-to-pay invoicing"
    },
    "invoice-detail": {
        "electronic_invoice": "Electronic invoice",
        "click_invoice_name_copy_then_go": "You can click on the invoice name and copy it, then go to the browser to open the address and download the invoice.",
    ...
    "invoice-saveinfo": {
        ...
        "invoicing": "Invoicing",
        "invoice_amount_must_greater_than": "The invoice amount must be greater than 0",
