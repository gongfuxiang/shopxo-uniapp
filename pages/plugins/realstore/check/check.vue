            ...
            <form @submit="form_submit" class="form-container">
                ...
                <view v-if="(success_order_data || null) != null" class="margin-top-xl border-radius-main bg-white padding-main spacing-mb">
                    ...
                    <view class="cr-base text-size-sm">
                        ...
                        <view class="padding-vertical-xs">{{$t('common.user_order_detail_order_number')}}：{{success_order_data.order_allot_no}}</view>
                        <view class="padding-vertical-xs">{{$t('common.order_time')}}：{{success_order_data.add_time}}</view>
                        <view class="padding-vertical-xs">{{$t('common.total_order_price')}}：<text class="cr-price fw-b">{{currency_symbol}}{{success_order_data.total_price}}</text></view>
                    </view>
