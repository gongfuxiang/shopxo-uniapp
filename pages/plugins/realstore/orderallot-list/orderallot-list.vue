            ...
            <view v-if="data_list.length > 0" class="padding-horizontal-main padding-top-main">
                <view v-for="(item, index) in data_list" :key="index" class="list-item padding-horizontal-main padding-top-main border-radius-main bg-white oh spacing-mb">
                    ...
                    " class="item-operation tr br-t padding-vertical-main">
                        ...
                        <button v-if="(item.operate_data.is_comments || 0) == 1" class="round bg-white cr-main br-main" type="default" size="mini" @tap="url_event" :data-value="'/pages/plugins/realstore/orderallot-comments/orderallot-comments?id=' + item.id" hover-class="none">{{$t('common.comment')}}</button>
