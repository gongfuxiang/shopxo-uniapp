            ...
            <view v-if="(plugins_wallet || null) != null" class="bottom-fixed padding-main">
                <view class="bottom-line-exclude oh">
                    <view class="bg-grey round oh">
                        ...
                        <button type="default" class="bg-grey br-grey cr-base round text-size fr" size="mini" :data-value="'/pages/plugins/wallet/payment-code/payment-code?screen_brightness_value=' + screen_brightness_value" data-redirect="1" @tap="url_event">钱包付款码</button>
                    </view>
                </view>
            </view>
        </block>
