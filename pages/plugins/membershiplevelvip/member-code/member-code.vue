        ...
        <block v-if="data_list_loding_status == 3">
            ...
            <view class="bottom-fixed padding-main">
                <view class="bg-gray round oh">
                    ...
                    <button type="default" class="bg-gray br-gray cr-base round text-size fr" size="mini" data-value="/pages/plugins/wallet/payment-code/payment-code" data-redirect="1" @tap="url_event">钱包付款码</button>
                </view>
            </view>
        </block>
