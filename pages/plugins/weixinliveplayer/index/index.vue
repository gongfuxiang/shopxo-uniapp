							...
							<view class="base flex-1 flex-width flex-col jc-sb">
								<view>
									...
									<view class="margin-top-sm oh flex-row flex-nowrap align-c">
										<iconfont name="icon-time" color="#ccc" size="28rpx" class="margin-right-sm"></iconfont>
								...
								<view class="self-e text-size-xs cr-grey-9 flex-row align-c" :class="' status-' + item.status">
									<!-- 未开始 -->
									<iconfont v-if="item.status==='0'" name="icon-time margin-right-xs pr top-xs"></iconfont>
									<!-- 直播中 -->
									...
									<!-- 其他 -->
									<iconfont v-else name="icon-lose-efficacy margin-right-xs pr top-xs"></iconfont>
									{{item.status_name}}
								</view>
							</view>
						</view>
