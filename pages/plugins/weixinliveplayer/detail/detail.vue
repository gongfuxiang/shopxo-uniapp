<template>
	<view>
		<view v-if="detail != null" class="page-bottom-fixed">
			<!-- 封面图片 -->
			<image v-if="(detail || null) != null && (detail.share_img || null) != null" class="banner wh-auto dis-block" :src="detail.share_img" mode="widthFix" @tap="detail_images_view_event"
				:data-value="detail.share_img"></image>
			...
			<view class="padding-horizontal-main">
				<view class="base padding-horizontal-main border-radius-main bg-white oh pr">
					...
					<view class="item padding-vertical-main br-t oh flex-row jc-sb">
						...
						<view class="flex-row flex-nowrap align-c flex-1 flex-width cr-grey-9 single-text padding-left-main">
