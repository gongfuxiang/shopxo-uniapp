        ...
        <view v-if="(data_base || null) != null" class="bg-white">
            <view class="pr wh-auto oh">
                ...
                <view class="banner oh pa top-0 pa-w wh-auto head-top">
                    <view class="tc">
                        <image :src="default_images_data.default_logo_app || vip_static + 'logo.png'" mode="widthFix" class="title-img"></image>
                        <!-- 标题 -->
    ...
    export default {
        data() {
            return {
                ...
                vip_static: vip_static + 'app/index/',
        ...
        methods: {
            ...
            get_data() {
                ...
                uni.request({
                    url: app.globalData.get_request_url('index', 'index', 'vip'),
                    method: 'POST',
                    data: {},
                    dataType: 'json',
                    success: (res) => {
                        ...
                        if (res.data.code == 0) {
                            ...
                            this.setData({
                                ...
                                buy_vip_btn: 'background-image: url(' + (default_images_data.default_btn_bg_app || vip_static+'app/index/btn.png')+') !important;',
                                data_list_loding_msg: '',
                            ...
                            if ((this.data_base || null) != null) {
                                ...
                                this.setData({
                                    share_info: {
                                        ...
                                        path: '/pages/plugins/vip/index/index',
