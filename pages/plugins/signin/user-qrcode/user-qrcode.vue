                ...
                <view v-if="data_list.length > 0" class="data-list padding-horizontal-main padding-top-main">
                    <view v-for="(item, index) in data_list" :key="index" class="item padding-main border-radius-main oh bg-white spacing-mb">
                        ...
                        <view class="operation tr br-t padding-top-main margin-top-main">
                            <button class="round cr-base br bg-white" type="default" size="mini" hover-class="none" :data-value="item.id" @tap="show_event">签到</button>
                            <button v-if="(data_base.is_team_show_coming_user || 0) == 1" class="round cr-white bg-main br-main" type="default" size="mini" hover-class="none" :data-value="item.id" @tap="coming_event">用户</button>
                            <button class="round cr-white bg-green br-green" type="default" size="mini" hover-class="none" :data-value="item.id" @tap="edit_event">编辑</button>
                        </view>
                    </view>
                </view>
                <view wx:else>
